        ...
        <a href="./profile.php?username=<?= urlencode($user->username) ?>">
          <div class="grid-sidebar">
            ...
            <div class="wrapper-left-elements">
              ...
              <a class="wrapper-left-active" href="./profile.php?username=<?= urlencode($user->username) ?>"
        ...
        <div class="box-home feed">
          <div class="container">
            <div class="row position-fixed box-name">
              ...
              <div class="col-xs-10">
                ...
                <p class="home-tweets-num">
                  <?php echo Tweet::countTweets($profileData->id); ?> Tweets
                </p>
              </div>
            </div>
            ...
            <div class="row mt-5">
              ...
              <div class="col-md-12">
                <img class="w-100 home-img-cover" src="assets/images/users/<?php echo $profileData->imgCover; ?>"
                  alt="">
              </div>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          <input type="text" name="name" class="form-control" id="exampleInputEmail1"
                            value="<?php echo $user->name; ?>" aria-describedby="emailHelp" placeholder="Name">
                        </div>
                        <div class="form-group">
            ...
            <div class="row home-follow ml-2 mt-1">
              <div class="col-md-3">
                <i class="count-following-i" data-follow="<?php echo $profileData->id; ?>">
                  <span
                    class="home-follow-count count-following"><?php echo Follow::countFollowing($profileData->id); ?></span>
                  Followings</i>
              </div>
              <div class="col-md-3">
                <i class="count-followers-i" data-follow="<?php echo $profileData->id; ?>">
                  <span
                    class="home-follow-count count-followers"><?php echo Follow::countFollowers($profileData->id); ?></span>
                  Followers</i>
              </div>
            </div>
