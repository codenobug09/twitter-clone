            ...
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                ...
                <style>
                  ...
                  /* Focus input */
                  form.py-4 .form-control:focus {
                    border-color: #1da1f2;
                    box-shadow: 0 0 0 2px rgba(29, 161, 242, 0.15);
                  }

                  /* Placeholder */
                  form.py-4 .form-control::placeholder {
                    color: #aab8c2;
                  }
                  ...
                  /* Button hover */
                  form.py-4 .btn-primary:hover {
                    background-color: #1a91da;
                    transform: translateY(-1px);
                  }

                  /* Button active */
                  form.py-4 .btn-primary:active {
                    transform: scale(0.97);
                  }

                  /* Center button spacing */
                  form.py-4 .text-center {
                    margin-top: 24px;
                  }
