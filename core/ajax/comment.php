	...
	<div class="retweet-popup">
		<div class="wrap5">
			...
			<style>
				...
				/* ===== TWEET PREVIEW ===== */
				.retweet-popup-body-wrap .grid-tweet {
					padding: 12px 18px;
				}

				.retweet-popup-body-wrap .grid-tweet:not(:last-child) {
					border-bottom: 1px solid #e6ecf0;
				}

				/* ===== USER AVATAR ===== */
				.retweet-popup-body-wrap .img-user-tweet {
					width: 44px;
					height: 44px;
					border-radius: 50%;
					object-fit: cover;
				...
				/* ===== USER INFO ===== */
				.retweet-popup-body-wrap strong {
					font-size: 15px;
				}

				.retweet-popup-body-wrap .username-twitter {
					font-size: 13px;
					color: #536471;
					margin-left: 6px;
				}
